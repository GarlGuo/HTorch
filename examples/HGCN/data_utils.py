...
def load_data(args, datapath):
    ...
    data_name = str(args.dataset)+'_'+str(args.task)+'_'+str(args.split_seed)+'.pickle'
    save_data_path = datapath+'/'+data_name
    if (os.path.exists(save_data_path)):
        with open(save_data_path, 'rb') as handle:
    ...
    ## Pubmed LP graph building takes a long time, save graph for every same split seed for next run
